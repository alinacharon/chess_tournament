                ...
                match choice:
                    ...
                    case "3":
                        if len(selected_tournament.registered_players) < 2:
                            print("Error: Minimum of 2 players required to generate rounds.")
                        else:
                            selected_tournament.create_rounds()
                            self.tournament_manager.save_tournament(selected_tournament)
                            print("Rounds generated successfully.")
                    case "4":
            ...
            try:
                ...
                if player_index == 0:
                    ...
                    if selected_player in tournament.registered_players:
                        ...
                        tournament.registered_players.append(selected_player)
                        self.tournament_manager.save_tournament(tournament)
                        MainView.print_info(f"{selected_player.name} added to the tournament.")
                else:
                    MainView.print_error_action()
            except ValueError:
                MainView.print_error_action()
